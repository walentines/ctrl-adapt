...
class StableDiffusionControlNetPipeline(
    ...
    def __init__(
        ...
        if isinstance(controlnet, (list, tuple)):
            controlnet = MultiControlNetModel(controlnet, fusion_model, fusion_model_mid)
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # summary(self.controlnet, input_data=(control_model_input, t, controlnet_prompt_embeds, image, cond_scale))
